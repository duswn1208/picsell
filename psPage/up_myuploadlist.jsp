...
<body>
	...
	<div class="wrapper">
		...
		<div class="ht__bradcaump__area" style="background-image:url(<%=cp%>/psPage/image/1920x270.jpg);">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" style="color: #ffffff; font-size: 30px;" ></a>
	...
	<form action="" name="myForm" method="post" enctype="multipart/form-data">
		...
		<tr>
			<td height="1" bgcolor="ffffff" align="center"><br/></td>
		</tr>
		</table>
		
		<div class="col-xs-12">
			<div class="blog__thumb" align="right" style="margin-right: 325px;">
				<a class="fr__btn" style="size: 10px; border-radius: 10px;" href="<%=cp%>/picsell/up_upload.do">LIST UPLOAD</a>&nbsp;&nbsp; 
				<a class="fr__btn" style="size: 10px; border-radius: 10px;" href="<%=cp%>/picsell/main.do">MAIN</a>
			</div>
		</div>
			...
			<div class="container">
				...
				<!-- Start Single Blog -->
					<c:if test="${!empty listss}">
						<c:forEach var="i" begin="0" end="${listss.size()-1}" step="1">
                        <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12">
                            <div class="blog">
                                <div class="blog__thumb">
                                    <a href="${imagePath}/${listss.get(i).originalName}"> 
										<img src="${imagePath}/${listss.get(i).originalName}" width="300" height="300" />
									</a>
                                </div>
                                <div class="blog__details">
                                    <div class="bl__date">
                                    	<div style="padding-left: 120px;" class="product-remove">
                                        ${listss.get(i).originalName }
                                        <a style="padding-left: 70px" href="${deletePath }?imageCode=${listss.get(i).imageCode}"><i class="icon-trash icons"></i><br/></a>
                                    	</div>  
                                    </div>
                                </div>
                            </div>

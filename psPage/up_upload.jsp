	...
	<div class="wrapper">
		...
		<form action="" name="myForm" method="post"
						...
						<div class="menumenu__container clearfix">
							...
							<div class="col-md-7 col-lg-8 col-sm-5 col-xs-3">
								...
								<ul class="main__menu">
									...
									<li class="drop"><a href="">Tag's</a>
										<ul class="dropdown mega_dropdown">
											...
											<li><a class="mega__title"
												href="<%=cp%>/picsell/list_video.do">VIDEO</a> <!-- <ul class="mvideoTaglist.jspega__item">
											...
											<!-- Start Single Mega MEnu -->
											<li><a class="mega__title"
												href="<%=cp%>/picsell/list_movie.do">MOVIE POSTER</a> <!--  <ul class="mega__item">
									...
									<c:choose>
										<c:when
											test="${!empty sessionScope.PicSellCustomInfo.userId }">
											<li class="drop"><a href="<%=cp%>/picsell/charge.do">CHARGE
													POINT</a>
										</c:when>
										<c:otherwise>
									...
									<li class="drop"><a href="<%=cp%>/picsell/up_myupload.do">MY
											UPLOAD</a></li>
			...
			<div class="htc__comment__area">
				<h4 style="margin-left: 350px;" class="title__line--5">FILE
					UPLOAD CONSTRAINTS</h4>
					...
					<table width="2000">
							...
							<td width="300">
								<div class="comment">
									<div class="comment__thumb">
										<img style="margin-left: 350px; padding-top: 20px;"
											src="<%=cp%>/psPage/image/photo-camera1.png"
											alt="comment images">
									</div>
									<div class="ht__comment__details">
										<div class="ht__comment__title">
											<h2 style="padding-top: 15px; padding-left: 15px;">
												동영상은 최대 300MB, 최소 해상도 1920x800입니다.<br /> 동영상들은 60초를 넘으면
												안됩니다.
											</h2>
										</div>
										<div class="reply__btn" style="padding-top: 10px;">
											<a style="padding-top: 1px;"
												href="https://pixabay.com/ko/blog/posts/image-quality-guidelines-22/">▶
												비디오품질지침 </a>
										</div>
										<p style="padding-top: 10px;">Exercitation photo booth
											stumptown tote bag Banksy</p>
									</div>
								</div>
							</td>
							<td width="300"><img style="margin-left: 150px;" height="80"
								width="100" src="<%=cp%>/psPage/data/cameraicon.png"
								alt="comment images"></td>
						</tr>
						<!-- End Single Comment -->
						<!-- Start Single Comment -->
						<tr>
							<td>
								<div class="comment comment--reply">
									<div class="comment__thumb">
										<img style="margin-left: 330px; padding-top: 20px;"
											src="<%=cp%>/psPage/image/picture.png" alt="comment images">
									</div>
									<div class="ht__comment__details">
										<div class="ht__comment__title">
											<h2 style="padding-top: 5px;">
												최대 40MB, 최소 3000 픽셀의 JPG, PNG, PSD, AI,<br /> 또는 SVG 포맷.
											</h2>
										</div>
										<div class="reply__btn" style="padding-top: 5px;">
											<a style="padding-top: 1px;"
												href="https://pixabay.com/ko/blog/posts/video-quality-guidelines-68/">▶
												이미지품질지침</a>
										</div>
										<p style="padding-top: 5px;">Exercitation photo booth
											stumptown tote bag Banksy</p>
									</div>
								</div>
							</td>
								...
								<div class="ht__comment__form">
									<div class="ht__comment__form__inner">
										<div class="comment__form">
											...
											<input name="imagetag" type="text" value="${t }"
												placeholder="Tag *" id="imagetag_text"> <input
												name="imagepoint" type="text" placeholder="Point *">
											&nbsp;&nbsp; Category:<input style="margin-left: 30px;"
												type="checkbox" name="category" value="video" />Video&nbsp;&nbsp;&nbsp;
						...
						<tr>
							<td>
								<div class="comment">
									<div class="comment__thumb">
										<img style="margin-left: 350px; margin-top: 15px;"
											src="<%=cp%>/psPage/image/photo-camera1.png"
											alt="comment images">
									</div>
									<div class="ht__comment__details">
										<div class="ht__comment__title">
											<h2 style="padding-top: 15px;">이 기간동안 남아있는 업로드 수는 10
												입니다.</h2>
										</div>
										<div class="reply__btn" style="padding-top: 10px;">
							...
							<td>&nbsp; &nbsp;인기 TAG : &nbsp;&nbsp; <a name="a" href="<%=cp%>/picsell/up_tag.do?chtag=연예인&check=no">#연예인&nbsp;&nbsp;</a>
								...
								<a name="f" href="<%=cp%>/picsell/up_tag.do?chtag=영화&check=no">#movie&nbsp;&nbsp;</a>
								<a name="g" href="<%=cp%>/picsell/up_tag.do?chtag=비디오&check=no">#flower&nbsp;&nbsp;</a>
								<a name="h" href="<%=cp%>/picsell/up_tag.do?chtag=비디오&check=no">#인기&nbsp;&nbsp;</a>
								<a name="i" href="<%=cp%>/picsell/up_tag.do?chtag=비디오&check=no">#팔로우&nbsp;&nbsp;</a>
								<a name="j" href="<%=cp%>/picsell/up_tag.do?chtag=비디오&check=no">#인스타그램&nbsp;&nbsp;</a>
							</td>
						</tr>
					</table>
				</div>
			...
			<br /> <input type="file" name="upload" size="50" value="찾아보기"
				style="background-color: #ffffff; padding-left: 500px;"> <br />
			<br />
			...
			<div class="col-xs-12">
				<div class="blog__thumb" align="right" style="margin-right: 325px;">
					<table style="margin-right: 450px">
						<tr>
							<td><a class="fr__btn"
								style="size: 10px; border-radius: 10px;" onclick="sendIt();">UPLOAD</a>&nbsp;&nbsp;
								<a class="fr__btn" style="size: 10px; border-radius: 10px;" onclick="reset();">RESET</a>&nbsp;&nbsp; <a class="fr__btn"
								style="size: 10px; border-radius: 10px;"
								href="<%=cp%>/picsell/main.do">CANCEL</a></td>
						</tr>
					</table>
				</div>
			</div>

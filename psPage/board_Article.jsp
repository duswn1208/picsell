										...
										<div class="col-xs-12">
												...
												<div class="single-contact-form">
													<div class="contact-box subject">
														<input type="text" name="subject" value="${board_dto.subject }">
													</div>
												</div>

												<div class="single-contact-form">
													<div class="contact-box name">
														<input type="button" name="userId" value="${board_dto.userId}">
														<input type="button" name="hitCount" value="조회수:${board_dto.hitCount }">
														<input type="button" name="linesu" value="줄수:${lineSu}">
														<input type="button" name="created" value="등록일:${board_dto.created }">
													</div>
												</div>
												...
												<div class="single-contact-form">
													<div class="contact-box message">
														<textarea name="content" placeholder="${board_dto.content }"></textarea>
													</div>
												</div>
												<div class="contact-btn" align="right">
													...
													<input type="hidden" name="searchValue"
														value="${searchValue }"> --%>
													<button type="submit" class="fv-btn" onclick="javascript:location.href='<%=cp%>/picsell/board_updated.do?num=${board_dto.num}&${params }';"/>수정</button>
													<button type="submit" class="fv-btn" onclick="javascript:location.href='<%=cp%>/picsell/board_deleted_ok.do?num=${board_dto.num}&${params }';"/>삭제</button>
												</div>

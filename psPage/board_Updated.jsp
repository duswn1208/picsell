...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp%>/picsell/board_updatedok.do";
		f.submit();
										...
										<div class="col-xs-12">
												...
												<div class="single-contact-form">
													<div class="contact-box name">
														<input type="text" name="userId" value="${board_dto.userId }">
												...
												<div class="contact-btn" align="right">
													...
													<button type="button" class="fv-btn" onclick="sendIt();"/>수정하기</button>
													<button type="button" class="fv-btn" onclick="javascript:location.href='<%=cp%>/picsell/board_memory.do?${params }';"/>수정취소</button>
												</div>

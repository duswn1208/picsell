...
<!-- Body main wrapper start -->
	...
	<form action="<%=cp%>/picsell/down_guest.do" method="post"
		...
		<table style="margin-left: 100px;">
			...
			<tr height="90">
				<td rowspan="7"><img src="${imagePath }/${dto.originalName}" width="800" height="750" style="margin-left: 200px; margin-right: 50px;"
					onmouseover="imageOver();" />
				</td>

				<td colspan="2" align="center" style="margin-left: 50px;">
					<img src="<%=cp%>/psPage/image/peo.JPG" width="70" height="70"/>&nbsp;&nbsp;
						...
						<td>
							<c:forEach var="i" begin="0" end="4" step="1">
								<c:if test="${i==0 }"><a href="<%=cp%>/picsell/down_imageClick.do?imageCode=${famous_list.get(i).imageCode}">
									<img src="${imagePath }/${famous_list.get(i).originalName}" width="230" height="230"/>&nbsp;</a>

								</c:if>
								<c:if test="${i==1}">
								<a href="<%=cp%>/picsell/down_imageClick.do?imageCode=${famous_list.get(i).imageCode}">
									<img src="${imagePath }/${famous_list.get(i).originalName}" width="230" height="230"/></a></td>
									</tr>
									<tr>
								</c:if>
								<c:if test="${i==2}">
...
<a href="<%=cp%>/picsell/down_imageClick.do?imageCode=${famous_list.get(i).imageCode}"><img src="${imagePath }/${famous_list.get(i).originalName}" width="230" height="230"/></a>&nbsp;
								</c:if>
	...
	<form action="<%=cp%>/picsell/down_guest.do" method="post">
		...
		<div>
			...
			<table width="600px" style="margin-left: 300px; border: 3px;">
				<c:forEach var="gdto" items="${guest_list }">
					<tr>

						<td rowspan="2" style="width: 60px;"><img
							src="<%=cp%>/psPage/image/who.JPG" width="59px" height="58px" /></td>
						<td colspan="2" align="left" style="font-size: 20px;"><a href="<%=cp %>/picsell/up_idupload.do?uploadUserId=${dto.uploadUserID }"><b>${gdto.psUserId }</b></a></td>
						<td></td>

					</tr>
					<tr>
						<td align="left" width="4000x" height="2" style="font-size: 18px;">${gdto.content }</td>
						
						<c:if test="${ sessionScope.PicSellCustomInfo.userId.equals(gdto.psUserId)}">
							<td width="200px"><a href="<%=cp %>/picsell/down_x.do?num=${gdto.num}&psUserId=${gdto.psUserId}&imageCode=${dto.imageCode}">삭제</a></td>
						</c:if>
